...
Electronic health records are the operating system of American healthcare. [Epic alone holds roughly 38% market share](https://www.definitivehc.com/resources/research/most-common-healthcare-it-systems#EHR) among U.S. hospitals, with Oracle Health (formerly Cerner) second. Together they cover more than half of all hospital beds.

Getting data out of these systems is the first hard problem. The [21st Century Cures Act](https://www.healthit.gov/topic/interoperability/information-blocking) mandates interoperability and prohibits information blocking, but mandates and reality are different things. FHIR (Fast Healthcare Interoperability Resources) is the standard, but implementation varies wildly across sites.
...
Babylon Health is the cautionary tale. At peak, the UK-based telehealth company was valued at [$4.2 billion after its SPAC merger in 2021](https://www.fiercehealthcare.com/digital-health/babylon-health-going-public-via-4-2b-spac-deal). Its AI triage chatbot made bold accuracy claims. But scaling into the U.S. market meant navigating state-by-state licensure, insurance contracting, and regulatory compliance that the demo never had to face. By 2023, Babylon had [filed for bankruptcy](https://www.bbc.com/news/business-66299740), having burned through over $1 billion.
...
The ambient scribe space is the clearest proof that workflow integration matters more than raw AI capability. [Nuance's DAX Copilot](https://www.nuance.com/healthcare/ambient-clinical-intelligence.html) (acquired by Microsoft for [$19.7 billion in 2022](https://news.microsoft.com/2022/03/04/microsoft-completes-acquisition-of-nuance-communications/)) works because it listens passively during the encounter and generates notes afterward. The clinician's workflow doesn't change. They talk to the patient the way they always have. The documentation happens in the background.
...
And liability is unresolved. If an AI system misses a cancer diagnosis, who's responsible? The physician who relied on it? The hospital that deployed it? The company that built it? The [AMA has called for clarity](https://www.ama-assn.org/practice-management/digital/ama-passes-first-policy-recommendations-augmented-intelligence) but no definitive legal framework exists yet. Until it does, risk-averse health systems will hesitate to deploy AI in clinical decision-making, no matter how good the demo looks.
...
There are limited [CPT codes for AI-assisted services](https://www.ama-assn.org/practice-management/cpt/cpt-codes-artificial-intelligence-ai). CMS has added a few for AI-enabled radiology analysis, but coverage is narrow. If a payer won't reimburse for the service the AI provides, the provider can't justify paying for it.
...
- [Definitive Healthcare: Most Common EHR Systems](https://www.definitivehc.com/resources/research/most-common-healthcare-it-systems#EHR)
- [21st Century Cures Act: Information Blocking](https://www.healthit.gov/topic/interoperability/information-blocking)
- [STAT News: IBM Watson + MD Anderson](https://www.statnews.com/2017/09/05/watson-ibm-cancer/)
- [IBM Divests Watson Health (2022)](https://newsroom.ibm.com/2022-01-21-IBM-Closes-Divestiture-of-Watson-Health-to-Francisco-Partners)
- [Babylon Health SPAC ($4.2B)](https://www.fiercehealthcare.com/digital-health/babylon-health-going-public-via-4-2b-spac-deal)
- [Babylon Health Bankruptcy (BBC)](https://www.bbc.com/news/business-66299740)
...
- [Microsoft Acquires Nuance ($19.7B)](https://news.microsoft.com/2022/03/04/microsoft-completes-acquisition-of-nuance-communications/)
...
- [AMA Policy on Augmented Intelligence](https://www.ama-assn.org/practice-management/digital/ama-passes-first-policy-recommendations-augmented-intelligence)
- [AMA CPT Codes for AI](https://www.ama-assn.org/practice-management/cpt/cpt-codes-artificial-intelligence-ai)
